...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.session) {
        setMessage("Kayit basarili. Ana sayfaya yonlendiriliyorsun.");

        setTimeout(() => {
          window.location.href = "/";
        }, 600);
      } else {
        setMessage("Kayit basarili. Email dogrulama gerekebilir.");
      }
    ...
    >
      ...
      >
        ...
        <p style={{ margin: "0 0 24px", color: "rgba(255,255,255,0.7)" }}>
          Create your Midilli App account to get started.
        </p>
